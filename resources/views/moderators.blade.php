                    ...
                    <div class="tab-pane fade in active show" id="tab_eight1">
                        <div class="row align-items-center justify-content-center g-0">
                            <div class="col-lg-6 md-mb-30px position-relative">
                                <img src="imgs/org.jpg" alt="" class="w-100">
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                ...
                                <h3 class="alt-font fw-500 text-dark-gray">الإشراف الإداري والتنظيمي</h3>
                                <p class="mb-30px">
            ...
            <div class="col-12 tab-style-08">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active show" id="tab_eight1">
                        <div class="row align-items-center justify-content-center g-0">
                            <div class="col-lg-6 md-mb-30px position-relative">
                                <img src="imgs/logi.JPG" alt="" class="w-100">
                                <!-- <div class="position-absolute top-30px xs-top-0px left-minus-80px lg-left-minus-50px xs-left-minus-0px xs-w-130px"><img src="images/demo-hotel-and-resort-amenities-07.png" alt="" /></div> -->
                            </div>
                            <div class="col-lg-5 offset-lg-1">
                                <!-- <span class="text-tussock-yellow fs-20 fw-600 d-inline-block mb-10px">الإشراف اللوجستي والخدمي</span> -->
                                <h3 class="alt-font fw-500 text-dark-gray">الإشراف اللوجستي والخدمي</h3>
                                <p class="mb-30px">نتولى الإشراف الكامل على جودة أماكن الإقامة في مكة والمدينة
    ...
    <div class="container">
        <div class="row align-items-center mb-8 md-mb-15 xs-mb-20">
            <div class="col-lg-5 md-mb-50px" data-anime='{ "el": "childs", "opacity": [0, 1], "rotateY": [-90, 0], "rotateZ": [-10, 0], "translateY": [80, 0], "translateZ": [50, 0], "staggervalue": 200, "duration": 800, "delay": 200, "easing": "easeOutCirc" }'>
                ...
                <h3 class="alt-font text-dark-gray ls-minus-2px">الإشراف الديني والإرشادي</h3>
            ...
            <div class="col-lg-6 offset-lg-1 position-relative">
                <div class="overflow-hidden position-relative xs-w-80 float-end" data-anime='{ "effect": "slide", "color": "#A0875B", "direction":"rl", "easing": "easeOutQuad", "duration": 600, "delay":400}'>
                    <img class="w-100" src="imgs/real.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active show" id="tab_eight1">
                        <div class="row align-items-center justify-content-center g-0">
                            <div class="col-lg-5">
                                <!-- <span class="text-tussock-yellow fs-20 fw-600 d-inline-block mb-10px">الإشراف اللوجستي والخدمي</span> -->
                                <h3 class="alt-font fw-500 text-dark-gray">إدارة الطوارئ والأمان</h3>
                                <p class="mb-30px">
                            ...
                            <div class="col-lg-6 offset-lg-1 md-mb-30px position-relative">
                                <img src="imgs/safe.JPG" alt="" class="w-100">
                                <!-- <div class="position-absolute top-30px xs-top-0px left-minus-80px lg-left-minus-50px xs-left-minus-0px xs-w-130px"><img src="images/demo-hotel-and-resort-amenities-07.png" alt="" /></div> -->
                            </div>
