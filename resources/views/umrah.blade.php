...
<?php
    ...
    ?>
<!-- start page title -->
<section class="page-title-separate-breadcrumbs cover-background top-space-margin position-relative" top-space-margin" data-parallax-background-ratio="0.5" style="background-image: url({{$pageData['hero-image']?asset('storage/' . $pageData['hero-image']):asset('imgs/umrah.jpg')}})">
            ...
            <div class="umrah-section-header mb-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        {!! $pageData['ten-days-note']??'<p class="fs-14 text-medium-gray mb-0 mt-1">مستوى خمس نجوم — <strong class="text-dark-gray">13 , 20 , 24 أغسطس 2026</strong></p>'!!}
