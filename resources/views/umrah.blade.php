...
.umrah-price-table .price-row:last-child { border-bottom: none; }
.umrah-price-table .price-row:nth-child(odd) { background: #fdfaf5; }
.umrah-price-table .price-row .price-label { color: #888; }
.umrah-price-table .price-row .price-val { font-weight: 700; color: #c59b46; }

/* Date chips */
.umrah-dates { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 14px; }
