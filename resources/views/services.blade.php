...
<?php include 'header.php'; ?>
                    ...
                    <div class="col-12 text-center position-relative page-title-extra-large">
                        <div class="d-flex flex-column small-screen">
                            <div class="mt-auto" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 400, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                                <h1 class="text-white alt-font mb-0 text-shadow-extra-large fw-600 ls-minus-1px">خدماتنا</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 position-relative">
                        <div class="row align-items-center position-relative md-mb-15" data-anime='{ "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="col-md-5 sm-mb-30px" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                                <img class="w-100" src="imgs/haj-3.jpg" alt="" />
                            </div>
                            <div class="col-lg-7 col-md-7 sm-mb-30px text-end" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
                                <img src="imgs/haj-2.jpg" alt="" class="box-shadow-quadruple-large md-w-100" />
                            </div>
                            <div class="w-50 sm-w-100 overflow-hidden position-absolute sm-position-relative left-140px bottom-minus-200px sm-bottom-0px sm-left-0px p-0 sm-ps-15px sm-pe-15px" data-shadow-animation="true" data-animation-delay="100" data-bottom-top="transform: translateY(20px)" data-top-bottom="transform: translateY(-20px)">
                                <img src="imgs/haj-1.jpg" alt="" class="box-shadow-quadruple-large w-100" />
                            </div>
                        </div> 
                    </div>
                    <div class="col-xl-5 col-lg-6 offset-xl-1 md-mt-20 sm-mt-0" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <span class="mb-10px text-tussock-yellow fs-22 fw-600 d-block">خدمة الحج</span>
                        <h3 class="alt-font text-dark-gray mb-5">الحج مع نيل مصر للسياحة</h3>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-9 last-paragraph-no-margin">
                        <span class="text-tussock-yellow fs-20 fw-600 d-inline-block mb-5px">من أول خطوة إلى آخر دعاء... نحن بجانبكم في كل لحظة</span>
                        <p class="ls-05px">
            ...
            <div class="container">
                <div class="row align-items-center mb-8 md-mb-15 xs-mb-20">
                    <div class="col-lg-5 md-mb-50px" data-anime='{ "el": "childs", "opacity": [0, 1], "rotateY": [-90, 0], "rotateZ": [-10, 0], "translateY": [80, 0], "translateZ": [50, 0], "staggervalue": 200, "duration": 800, "delay": 200, "easing": "easeOutCirc" }'>
                        <span class="text-tussock-yellow fs-20 fw-600 d-inline-block mb-10px">خدمة العمرة</span>
                        <h3 class="alt-font text-dark-gray ls-minus-2px">العمرة مع نيل مصر للسياحة</h3>
                    ...
                    <div class="col-lg-7 position-relative"> 
                        <div class="overflow-hidden position-relative xs-w-80 float-end" data-anime='{ "effect": "slide", "color": "#A0875B", "direction":"rl", "easing": "easeOutQuad", "duration": 600, "delay":400}'>
                            <img class="w-100" src="imgs/omra-1.jpg" alt="" >
                        </div>
                        <div class="position-absolute left-minus-70px md-left-15px bottom-minus-50px w-55 overflow-hidden" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)" data-anime='{ "effect": "slide", "color": "#ffffff", "direction":"lr", "easing": "easeOutQuad", "duration": 600, "delay":500}'>
                            <img class="w-100" src="imgs/omra-2.jpg" alt="">
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <section class="pt-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-9 last-paragraph-no-margin">
                        <span class="text-tussock-yellow fs-20 fw-600 d-inline-block mb-5px">نرافقكم بخبرة واهتمام... لتعيشوا رحلة إيمانية لا تُنسى</span>
                        <p class="ls-05px">
                            ...
                            <div class="tab-pane fade in active show" id="tab_eight1">
                                <div class="row align-items-center justify-content-center g-0">
                                    <div class="col-lg-6 md-mb-30px position-relative">
                                        <img src="imgs/egy.jpg" alt="" class="w-100">
                                    ...
                                    <div class="col-lg-5 offset-lg-1">
                                        <span class="text-tussock-yellow fs-20 fw-600 d-inline-block mb-10px">نقرّب إليكم رحلة الحج أينما كنتم في دول الخليج.</span>
                                        <h3 class="alt-font fw-500 text-dark-gray">خدمات الحج للمصريين المقيمين بدول الخليج</h3>
