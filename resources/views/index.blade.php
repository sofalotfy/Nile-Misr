    ...
    <div class="position-absolute top-0 start-0 w-100 h-100 z-index-9 pointer-events-none">
        ...
        <div class="container h-100">
            <div class="row justify-content-center h-100">
                ...
                <div class="position-absolute d-none d-xl-flex justify-content-center align-items-center opacity-5" style="top: 50%; left: 50%; transform: translate(-50%, -50%); width: 600px; z-index: 0; pointer-events: none;">
