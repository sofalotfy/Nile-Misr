    ...
    <div class="position-absolute top-0 start-0 w-100 h-100 z-index-9 pointer-events-none">
        ...
        <div class="container h-100">
            <div class="row justify-content-center h-100">
                ...
                <div class="position-absolute d-none d-xl-flex justify-content-center align-items-center opacity-5" style="top: 60%; left: 50%; transform: translate(-50%, -50%); width: 708px; z-index: 0; pointer-events: none;">
                ...
                <div class="col-xxl-8 col-xl-10 h-100 text-center d-flex flex-column align-items-center justify-content-center position-relative z-index-1">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start" style="pointer-events: auto;" data-anime='{ "el": "childs", "translateY": [20, 0], "opacity": [0,1], "duration": 600, "delay":600, "staggervalue": 600, "easing": "easeOutQuad" }'>
