                    ...
                    <div class="row justify-content-center h-100">
                        ...
                        <div class="col-xxl-8 col-xl-10 h-100 text-center d-flex flex-column align-items-center justify-content-center position-relative z-index-1">
                            <div class="" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                <div class="text-tussock-yellow fs-20 fw-600 text-uppercase" style="color: #dda947ff;">نحمل قلوبكم لبيت الله</div>
                            </div>
                            <h1 class="fw-600 ls-minus-1px text-white mb-20px" data-fancy-text='{ "scale": [1.1, 1], "rotateX": [20, 0], "opacity": [0, 1], "translateX": [-20, 0], "translateY": [20, 0], "delay": 0, "speed": 40, "easing": "easeOutQuad" }'>نيل مصر للسياحة</h1>
                            <p class="w-50 fs-20 mb-30px md-w-80 sm-w-100 text-very-light-gray" data-anime='{ "el": "lines", "translateY": [20, 0], "opacity": [0,1], "duration": 600, "delay":500, "staggervalue": 300, "easing": "easeOutQuad" }'>الشركة الرائدة للحج والعمرة في مصر أكثر من عشرين عاما في خدمة زوار بيت الله</p>
                            <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start pointer-events-auto" data-anime='{ "el": "childs", "translateY": [20, 0], "opacity": [0,1], "duration": 600, "delay":600, "staggervalue": 600, "easing": "easeOutQuad" }'>
                                ...
                                <div class="btn btn-large btn-base-color-2 btn-rounded btn-box-shadow sm-mb-15px" style="color: #ffc251ff; background-color: #2e2006ff;">موسم حج 1448هـ</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 500, "easing": "easeOutQuad" }'>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex-shrink-0 me-15px md-me-0">
                                    <h2 class="mb-0 fw-800"><sup class="fs-24">+</sup>250k</h2>
                                </div>
                                <div>
                                    <span class="lh-24 fw-600 d-block">اكثر من 250 الف حاج ومعتمر</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <span class="lh-24 fw-600 d-block">أفضل شركة سياحة دينية</span>
                                </div>
                            </div>
                        </div>
                        <!-- end content box item -->
                        ...
                        <div class="col pt-35px pb-35px text-dark-gray">
                            <div
                                class="d-flex flex-column flex-lg-row align-items-center justify-content-center text-center text-lg-start">
                                <div class="flex-shrink-0 me-15px md-me-0">
                                    <h2 class="mb-0 fw-800"><sup class="fs-24">+</sup>3.5k</h2>
                                </div>
                                <div>
                                    <span class="lh-24 fw-600 d-block">+3500 ريفيو ع جوجل</span>
                                </div>
                            </div>
                        </div>
                        <!-- end content box item -->
                ...
                <div class="container">
                    <div class="row justify-content-between align-items-center sm-pb-9">
                        <div class="col-lg-6 col-md-9 position-relative md-mb-15 text-center text-lg-start d-flex align-items-center justify-content-center"
                            ...
                            <img src="imgs/journy.jpg" alt="">
                            <img src="imgs/pattern/patt12.png" class="position-absolute top-50 left-minus-100px lg-left-minus-40px sm-left-minus-30px lg-w-50 sm-w-55" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-220px)" alt="">
                        ...
                        <span class="mb-10px text-tussock-yellow fs-22 fw-600 d-block">نحمل قلوبكم لبيت الله</span>
                        <h2 class="alt-font text-dark-gray ls-minus-2px">رحلة نيل مصر عبر ربع قرن من الإنجاز</h2>
                        ...
                        <a href="about.php" class="btn btn-large btn-yellow btn-hover-animation-switch btn-box-shadow btn-rounded me-25px xs-me-0">
                                <span>
                                    <span class="btn-text">من نــحــن؟</span>
                                    <span class="btn-icon"><i class="feather icon-feather-arrow-left"></i></span>
                                    <span class="btn-icon"><i class="feather icon-feather-arrow-left"></i></span>
                                </span>
                            </a>
                            <span class="text-dark-gray fw-700 ls-minus-05px d-block d-sm-inline-block sm-mt-15px"><a href="tel:19740"><i class="feather icon-feather-phone-call me-10px"></i>19740</a></span>
                    </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container-fluid">  
                <div class="row justify-content-center mb-1">
                    <div class="col-xxl-4 col-xl-5 col-lg-7 col-sm-9 text-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <span class="fs-15 text-uppercase text-base-color fw-600 mb-10px d-block ls-1px">برامج العمرة</span>
                        <h3 class="fw-700 text-dark-gray ls-minus-1px">أحدث برامج العمرة المتاحة</h3>
                    </div>
                </div>
                <div class="row">
        ...
        <!-- end section -->  
            ...
            <section class="pb-0 position-relative overflow-hidden">
                ...
                <div class="text-center position-absolute top-150px mt-70px sm-mt-0 w-100 d-flex justify-content-center align-items-center" style="opacity: 0.5; z-index: 0; pointer-events: none;" data-bottom-top="transform: translate3d(0px, 0px, 0px) scale(.8);" data-top-bottom="transform: translate3d(0px, 0px, 0px) scale(1.3);">
                    <img src="imgs/pattern/patt7.png" class="patt6-spin" style="max-width: 600px; width: 80vw;" alt="">
                </div>
                <div class="position-relative" style="z-index: 1;">
                    <div class="row p-0">
                        <div class="col-12 text-center" data-anime='{ "translateY": [50, 1], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue":200, "easing": "easeOutQuad" }' >
                            <img src="imgs/eff-3.png" class="" alt="">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 lg-mb-45px xs-mb-30px text-sm-start text-center">
                        <span class="fs-60 xs-fs-50 fw-500 text-dark-gray mb-0 ls-minus-2px">تجارب ضيوف الرحمن</span>
                    </div>
                    <div class="col-xl-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="d-flex align-items-center justify-content-center justify-content-sm-end">
                                    <div class="fw-700 fs-70 text-dark-gray me-15px ls-minus-1px">4.9</div>
                                    <div class="text-center">
                                        ...
                                        <span class="text-dark-gray fs-13 fw-700 text-uppercase">آراء العملاء</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
